        				...
        				foreach ($racesresults as $race) {
				            ...
				            if ($indraceresults) {
				            	...
				            	foreach ($indraceresults as $indrace) {
				            		...
				            		$htmlout .= '<input type="hidden" name="id-'.$electionrecordid.'"  value="'.$electionrecordid.'">';
				            		$htmlout .= '<dt class="eai-election-inputs-item-cand">'.$indrace->candidate.'</dt>';
				            		if ($indrace->reported) {
				            			$htmlout .= '<dd><input name="report-'.$electionrecordid.'" type="checkbox" label="reported"></dd>';
				            			$htmlout .= '<dd><input type="number" name="votes-'.$electionrecordid.'" label="'.$indrace->candidate.'" value="'.$indrace->votes.'"></dd>';
				            		} else {
				            			$htmlout .= '<dd><input name="report-'.$electionrecordid.'" type="checkbox" label="reported" checked></dd>';
				            			$htmlout .= '<dd><input type="number" name="votes-'.$electionrecordid.'" label="'.$indrace->candidate.'" ></dd>';
				            		}
				            		$htmlout .= "<br>";
